...
public class FruitResource {
	...
	public Response create(Fruit fruit) {
		if (fruit.id != null) {
			throw new WebApplicationException("If was invalidly set on request.", 422);
		}
		fruit.persist();
	...
	public Fruit update(@PathParam Long id, Fruit fruit) {
		...
		if (entity == null) {
			throw new WebApplicationException("Fruit with id of" + id + "dose not exist.", 404);
		}
	...
	public static class ErrorMapper implements ExceptionMapper<Exception> {
		...
		public Response toResponse(Exception exception) {
			...
			if (exception.getMessage() != null) {
				exceptionJson.put("err", exception.getMessage());
			}
